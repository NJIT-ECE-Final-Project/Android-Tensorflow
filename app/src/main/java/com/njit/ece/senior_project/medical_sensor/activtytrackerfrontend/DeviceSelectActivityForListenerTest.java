 ...
 */
public class DeviceSelectActivityForListenerTest extends Activity implements PullToRefresh.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(DeviceSelectActivityForListenerTest.this, BluetoothListenerTest.class);
        ...
        not_found.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DeviceSelectActivityForListenerTest.this, DeviceScanActivity.class);
                startActivity(i);
            }
        });
            ...
            if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
                ...
                switch (state) {
                    case BluetoothAdapter.STATE_OFF:
                        ...
                        Toast.makeText(DeviceSelectActivityForListenerTest.this, "Turn on bluetooth", Toast.LENGTH_LONG).show();
                        break;
